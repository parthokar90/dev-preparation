...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <html lang="en">
      <body
        className={`${inter.className} bg-white text-black flex flex-col min-h-screen`}
      >
        <nav className="border-b border-black py-4 px-6 md:px-12 flex justify-between items-center">
          ...
          <div>
            <Link
              href="/login"
              className="bg-black text-white px-5 py-2 text-sm font-medium hover:bg-neutral-800 transition"
            >
              Login
            </Link>
          </div>
